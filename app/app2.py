...
# COMMENTED OUT: pkl model loading code that causes deployment issues
...
# COMMENTED OUT: Dataset answer function that uses the pkl model
...
def chat():
    try:
        ...
        # COMMENTED OUT: Dataset answer retrieval using pkl model
        ...
        # Generate response with Gemini (this part remains active)
